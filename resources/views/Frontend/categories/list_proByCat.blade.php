...
<div class="beta-products-list">
	...
	echo '<h2 class="title ">' . 'Danh mục:' . $byCate->name . '</h2>';

} else {
	echo '<h2 class="title ">List Products</h2>';
}
?></h4>
<input type="hidden" name="id"  id="id" value="{{$byCate->id }}">
		...
		<div class="row text-center" id="productData">
            ...
            <div class="product-grid4">
                ...
                <div class="product-content">
                    ...
                    <div class="price">
                        {{number_format($product->price*($product->sale/100), 2, ',', '.').' VNĐ'}}
